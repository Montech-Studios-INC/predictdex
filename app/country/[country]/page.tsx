  ...
  return (
    <div className="space-y-10">
      <header className="rounded-3xl border border-slate-200 bg-white px-8 py-10 shadow-sm">
        <p className="text-xs uppercase tracking-[0.4em] text-emerald-700">Country Focus</p>
        <h1 className="mt-4 text-4xl font-semibold text-slate-900">{match}</h1>
        <p className="mt-3 text-sm text-slate-600">Drill into {match} narratives with curated liquidity.</p>
      </header>
